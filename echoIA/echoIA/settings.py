"""
Django settings for echoIA project.
...
SECRET_KEY = 'django-insecure-jmoy8n%@)#)gcq_r4q8hz9bra5n4j1d(aqs+fo(+bu63ckb(s7'
...
MIDDLEWARE = [
    ...
    'django.middleware.csrf.CsrfViewMiddleware',  # Certifique-se de que isso está presente
...
WSGI_APPLICATION = 'echoIA.wsgi.application'
...
LOGIN_REDIRECT_URL = '/transcription/'  # URL para onde redirecionar após login bem-sucedido
